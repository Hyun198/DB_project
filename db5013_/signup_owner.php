...
<html lang="ko">
 <head>
    ...
    <body>
        ...
        <div class="intro_bg"> 
        <form action="signup_ownercheck.php" method="post" >
            

            <fieldset>
                <legend> 음식점 회원가입 </legend>
                <ul>
                <!-- em : 진하게, 강조 -->
                <!-- id : lable의 for랑 연결된 부분 / name은 다른 파일로 넘겨줄 파라미터 명 -->
                    ...
                    <input type="text" id="new_id" name="new_id" size="20" autocomplete="on" required>
                           ...
                           <li> <label class="reg" for="new_pw1"> 비밀번호 <em> * </em> </label>
                            ...
                            <li> <label class="reg" for="user_name"> 음식점 이름 <em> * </em> </label>
                                <input type="text" id="user_name" name="user_name" size="20" required>
                            </li>
                            <li> <label class="reg" for="user_address" id="user_address" name="user_address"> 지역번호 <em> * </em> </label>
